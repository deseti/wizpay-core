export const OFFICIAL_SWAP_ALLOWED_CHAIN = 'ARC-MAINNET' as const;
export const OFFICIAL_SWAP_MAINNET_EXECUTOR = 'mainnet-uniswap-v4' as const;

export const OFFICIAL_SWAP_ERROR_CODES = {
  EXECUTION_FAILED: 'OFFICIAL_SWAP_EXECUTION_FAILED',
  QUOTE_FAILED: 'OFFICIAL_SWAP_QUOTE_FAILED',
...
export type OfficialSwapExecutorConfigured =
  | 'disabled'
  | typeof OFFICIAL_SWAP_MAINNET_EXECUTOR
  | 'unsupported';
