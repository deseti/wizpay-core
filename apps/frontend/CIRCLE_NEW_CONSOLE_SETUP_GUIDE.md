...
```powershell
npm --prefix d:\wizpay\apps\frontend run circle:entity-secret:rotate
```
...
```powershell
npm --prefix d:\wizpay\apps\frontend run circle:entity-secret:doctor
npm --prefix d:\wizpay\apps\frontend run build
```
...
```powershell
npm --prefix d:\wizpay\apps\frontend run dev
```
